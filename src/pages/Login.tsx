      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 relative">
            <div className="absolute inset-0 bg-primary-600 rounded-xl rotate-45 transform origin-center"></div>
            <Lock className="relative z-10 text-white h-full w-full p-3" />
          </div>
